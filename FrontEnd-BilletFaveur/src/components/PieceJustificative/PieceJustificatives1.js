...
export default class PieceJustificatives1 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      PieceJustificatives: [],
      currentPieceJustificative:PieceJustificatives1,
      currentIndex: "",
      currentPieceJustificative:PieceJustificatives1,
     // searchTitle: ""
      loading:true, 
...
addPieceJustificative(){
  ...
  retrievePieceJustificatives() {
    ...
    PieceJustificativeAction.getPieceJustificatives2(this.state.personnel)
      .then(response => {
        this.setState({
  ...
  return (
    ...
    <><div className="section big-55-height over-hide z-bigger">
      ...
      <form onChange={this.retrievePieceJustificatives()}>
