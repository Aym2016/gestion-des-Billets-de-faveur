...
export default class CreateDemandeBilletCompagnieEtrangereComponent extends Component {
    constructor(props) {
        super(props)
        ...
        return (
           ...
           <><div>
                <div className="section big-55-height over-hide z-bigger">
                    <div className="parallax parallax-top" style={{ backgroundImage: 'url(img/1.png)' }}></div>
