    ...
    render() {
        return (
            <div>
                ...
                <div class="section padding-top-bottom-small background-blue over-hide footer">
                    <div class="container">
                        <div class="row">
...
<br/>Tunis Carthage, 1035 Tunis-Tunisie</p>
                            </div>
    ...
    <img src="img/logos/3.png" alt=""/>*/}
                ...
                <div class="section py-4 background-blue over-hide footer-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center text-md-left mb-2 mb-md-0">
                                <p>2022 © Tunisair. All rights reserved.</p>
                            </div>
