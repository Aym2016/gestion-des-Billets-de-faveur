...
/*<div className="form-group mb-1">
                                            ...
                                            <input type="text" name="code" defaultValue={code}
                                                   ...
                                                   placeholder="Enter nouveau TypeDecision"/>
                                        </div>*/
// import 'font-awesome/css/font-awesome.min.css'
export default class AddTypeDecision extends Component {
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-12 parallax-fade-top">
                                    <div className="hero-text">ajouter Nouveau Decision </div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-xl-12">
                            <div className="card" style={{textAlign: "left"}}>
                                ...
                                <div className="card-body">
                                    <form onSubmit={this.AddTypeDecision}>
                                        ...
                                        <div className="form-group mb-1">
                                            ...
                                            <input type="text" name="libelle" defaultValue={libelle}
                                                   ...
                                                   placeholder="Entrer libelle decision"/>
                                        </div>
                                       
                                        
                                        <button type="submit" className="btn btn-primary">Ajouter Nouveau decision</button>
                                    </form>
                                </div>
